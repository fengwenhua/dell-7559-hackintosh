 ...
 *
 * Disassembly of SSDT-5-SaSsdt.aml, Fri Jan  4 00:18:12 2019
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000053B6 (21430)
 *     Revision         0x02
 *     Checksum         0x83
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    OperationRegion (SANV, SystemMemory, 0x77AB0D98, 0x0135)
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Method (PGON, 1, Serialized)
        {
            ...
            GPPR (PION, One)
            If (LOr (LEqual (OSYS, 0x07D9), LEqual (OSYS, 0x07DD)))
            {
                If (LEqual (PION, Zero))
                {
                    Store (Zero, P0AP)
