 ...
 *
 * Disassembly of SSDT-4-DptfTabl.aml, Fri Jan  4 00:18:12 2019
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000035D6 (13782)
 *     Revision         0x02
 *     Checksum         0x72
 *     OEM ID           "DptfTa"
...
DefinitionBlock ("", "SSDT", 2, "DptfTa", "DptfTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC__.DIMM, FieldUnitObj)
    External (_SB_.PCI0.LPCB.EC__.DTS1, FieldUnitObj)
    External (_SB_.PCI0.LPCB.EC__.SYST, FieldUnitObj)
    ...
    Scope (\_SB.PCI0.B0D4)
    {
        ...
        Method (TMPX, 0, Serialized)
        {
            ...
            {
                Return (\_SB.IETM.CTOK (\_SB.PCI0.LPCB.EC.DTS1))
            }
            Else
            {
                Return (0x0BB8)
    ...
    Scope (\_SB.PCI0)
    {
        Device (TMEM)
        {
            ...
            Method (TMPX, 0, Serialized)
            {
                If (\_SB.PCI0.LPCB.ECOK ())
                {
                    Store (\_SB.PCI0.LPCB.EC.DIMM, Local1)
    ...
    Scope (\_SB.PCI0.LPCB.EC)
    {
        Device (SEN1)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                If (\_SB.PCI0.LPCB.ECOK ())
                {
                    Return (\_SB.IETM.CTOK (\_SB.PCI0.LPCB.EC.SYST))
                }
                Else
                {
                    Return (0x0BB8)
    ...
    Scope (\_SB.PCI0.LPCB.EC)
    {
        Device (SEN2)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                If (\_SB.PCI0.LPCB.ECOK ())
                {
                    Return (\_SB.IETM.CTOK (\_SB.PCI0.LPCB.EC.DIMM))
                }
                Else
                {
                    Return (0x0BB8)
