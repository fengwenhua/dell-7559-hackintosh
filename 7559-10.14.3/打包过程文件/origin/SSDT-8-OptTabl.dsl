 ...
 *
 * Disassembly of SSDT-8-OptTabl.aml, Fri Jan  4 00:18:13 2019
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000019FF (6655)
 *     Revision         0x01
 *     Checksum         0x29
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC__.DTS1, FieldUnitObj)
    ...
    External (_SB_.PCI0.PEG0.PEGP.LTR1, IntObj)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        Method (_ON, 0, Serialized)  // _ON_: Power On
        {
            ...
            Store (\_SB.PCI0.PEG0.PEGP.LTR1, \_SB.PCI0.PEG0.LREN)
        ...
        Method (_OFF, 0, Serialized)  // _OFF: Power Off
        {
            ...
            PGOF (One)
            Store (\_SB.PCI0.PEG0.LREN, \_SB.PCI0.PEG0.PEGP.LTR1)
        }
    }
                    ...
                    While (One)
                    {
                        ...
                        If (LEqual (_T_1, Zero))
                        {
                            If (CPUT)
                            {
                                ...
                                {
                                    Store (\_SB.PCI0.LPCB.EC.DTS1, PDTS)
                                }
                            }
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        {
            Store ("<<< GC6O >>>", Debug)
            While (LEqual (\_SB.GGIV (0x01030012), Zero))
            {
                Sleep (One)
            }

            Store (Zero, \_SB.PCI0.PEG0.LNKD)
            \_SB.PCI0.SGPO (SGGP, Zero, 0x01030011, Zero, One)
            While (\_SB.GGIV (0x01030012))
            {
                Sleep (One)
            }

            \_SB.PCI0.SGPO (SGGP, Zero, 0x01030011, Zero, Zero)
            While (LLess (\_SB.PCI0.PEG0.LNKS, 0x03))
            {
                Sleep (One)
            }
